...
// --- Lazy Loading (বাকি সব আগের মতোই আছে) ---
...
const AppContent = () => {
  ...
  const [isLoaderActive, setIsLoaderActive] = useState(true); // লোডার কন্ট্রোল করার স্টেট

  useEffect(() => {
    // সেশন স্টোরেজ লজিক (কার্ট ক্লিয়ারেন্স)
    ...
    if (rawData) {
      ...
      if (parsedCart.length > 0 && parsedCart[0].addedAt) {
        ...
        if (timeNow - parsedCart[0].addedAt > 4 * 60 * 60 * 1000) {
    ...
    // ঠিক ৩.৫ সেকেন্ড পর মেইন অ্যাপ রেন্ডার হবে
  ...
  // যদি লোডার একটিভ থাকে, তবে শুধু লোডার দেখাবে, অ্যাপের বাকি অংশ দেখাবে না
  if (isLoaderActive) {
